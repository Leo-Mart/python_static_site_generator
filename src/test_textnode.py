...
class TestTextNode(unittest.TestCase):
  ...
  def test_repr(self):
    ...
    self.assertEqual(
      "TextNode(This is a text node, text, https://www.test.com)", repr(node)
    )
...
class TestTextNodeToHTMLNode(unittest.TestCase):
  ...
  def test_image(self):
    node = TextNode("This is an image", TextType.IMAGE, "https://www.imageurl.com")
    html_node = text_node_to_html_node(node)
    self.assertEqual(html_node.tag, "img")
    self.assertEqual(html_node.value, "")
    self.assertEqual(
        html_node.props,
        {"src": "https://www.imageurl.com", "alt": "This is an image"},
    )
